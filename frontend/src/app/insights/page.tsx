    ...
    <div className="page-root" style={{ background: 'var(--bg)', fontFamily: "'Inter', sans-serif", color: 'var(--text)' }}>
      ...
      <main className="page-layout-main main-content-with-topbar">
        ...
        <div className="page-body-container" style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div className="grid-4col" style={{ display: 'grid', gap: '10px', flexShrink: 0 }}>
            {[
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              {Object.keys(impactAssessment).length > 0 && (
                <div className="premium-card">
                  ...
                  <div className="grid-2col" style={{ display: 'grid', gap: '10px' }}>
              ...
              <div className="premium-card" style={{ borderTop: '3px solid var(--primary)' }}>
                ...
                <div className="grid-4col" style={{ display: 'grid', gap: '10px' }}>
